...
PERMISSION_CATALOG: dict[str, dict[str, str]] = {
    ...
    "b2c.intake": {
        "label": "Intake B2C",
        "description": "Importer/creer des leads B2C consentis.",
        "category": "b2c",
    },
    "b2c.consent.manage": {
        "label": "Gerer Consentements B2C",
        "description": "Mettre a jour le consentement et la conformite B2C.",
        "category": "b2c",
    },
    "extraction.view": {
...
PERMISSION_PRESETS: dict[str, dict[str, object]] = {
    ...
    "b2b_hunter": {
        "label": "B2B Hunter",
        "description": "Prospection B2B: extraction, qualification et export.",
        "permissions": {
            "access.manager",
            "leads.view",
            "leads.export",
    ...
    "b2c_consent_operator": {
        "label": "B2C Consent Operator",
        "description": "Intake B2C, gestion consentement et suivi qualite des leads.",
        "permissions": {
            "access.manager",
            "leads.view",
            "leads.manage",
    ...
    "growth_hybrid": {
        "label": "Growth Hybrid B2B/B2C",
        "description": "Equipe growth mixte: B2B extraction + B2C consent + export.",
        "permissions": {
            "access.manager",
            "leads.view",
            "leads.export",
